from agentic_chatbot_db_tools_rag import ingest_rag_documents,chatbot, get_all_threads, delete_thread,get_retriever
...
user_input= st.chat_input(placeholder='Type Here...',accept_file = True,file_type = ["pdf"],max_upload_size=200)
#processing user input
if user_input:

    user_message = user_input.text
    # print(user_input.files)
    set_thread_title_from_message(st.session_state['thread_id'], user_message)
